...
# Session-gated control/surface toolsets: off ``_HERMES_CORE_TOOLS`` so other
# sessions never pay their schema; once enabled they stay direct unless the
# deferral list names them.
_DIRECT_SURFACE_TOOLSETS = frozenset({"desktop_ui", "project", "goals"})
