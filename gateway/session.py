...
class SessionSource:
    ...
    # Local-only result of an adapter-owned external resource authorization
    # check. Deliberately excluded from ``to_dict``/``from_dict``: this is an
    # in-process trust marker, not persisted or wire-provided input.
